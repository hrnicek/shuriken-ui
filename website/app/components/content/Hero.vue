        ...
        >
          <span class="relative">
            <Icon
              ...
              class="h-4 w-4 transition-opacity duration-300 group-hover/button:opacity-0"
            />
            <Icon
              name="fa:star"
              class="absolute start-0 top-1 h-4 w-4 -rotate-180 opacity-0 transition-all duration-300 group-hover/button:!rotate-0 group-hover/button:!opacity-100"
            />
          </span>
