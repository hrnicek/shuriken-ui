...
<template>
  <SelectItem
    v-bind="forward"
    class="text-xs leading-none text-muted-500 flex items-center ps-[35px] ps-[25px] relative select-none data-[disabled]:text-muted-300 data-[disabled]:pointer-events-none data-[highlighted]:outline-none"
    :class="[
