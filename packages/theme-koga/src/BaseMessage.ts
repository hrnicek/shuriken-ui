...
export const iconVariants = {
  ...
  'info': 'text-white dark:text-white bg-info-500 dark:bg-info-500',
  'success': 'text-white dark:text-white bg-success-500 dark:bg-success-500',
  'warning': 'text-white dark:text-white bg-warning-500 dark:bg-warning-500',
  'destructive': 'text-white dark:text-white bg-destructive-500 dark:bg-destructive-500',
} as const satisfies Record<NonNullable<BaseMessageProps['variant']>, string>
