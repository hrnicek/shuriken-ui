...
::component-header{category="components/form" fileName="BaseFullscreenDropfile.vue" }
::

::code-group{expandable}
```vue [DemoInputDropfileBase.vue]
<template>
  <div>
      ...
      <div role="button" tabindex="-1" class="" @dragenter.stop.prevent @dragover.stop.prevent @drop="drop">
        ...
        >
          <div class="p-5 text-center">
            <Icon name="mdi-light:cloud-upload" class="mx-auto text-muted-400 group-hover:text-primary-500 group-focus:text-primary-500 mb-2 size-10 transition-colors duration-300" />
...
## Anatomy
This component is self closing and can be used to create a dropfile area. You can use it in cunjunction with the `BaseInputFileHeadless` component to create a full file upload experience.

::code-group

```vue [BaseFullscreenDropfile]
<template>
  <BaseFullscreenDropfile />
</template>
```
