        ...
        <div class="relative w-full grow flex">
          ...
          <div class="hidden xl:block shrink-0 h-full w-72 bg-muted-50/60 dark:bg-muted-950 border-e border-muted-200 dark:border-muted-800">
            <div class="px-6 py-10 space-y-8">
              <div
                v-for="category in Object.keys(menu)"
                :key="category"
                class="relative"
              >
                ...
                >
                  <li
                    v-for="item in menu[category as any]"
                    :key="item.title"
                    class="relative"
                  >
                    <NuxtLink
                      :to="item.to"
                      class="py-2 px-3 font-sans flex items-center gap-3 rounded-lg"
                      exact-active-class="bg-muted-200/60 dark:bg-muted-800"
                    >
                      <Icon
                        :name="item.icon"
                ...
                <div class="mb-6">
                  <div class="relative z-0 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 ltablet:grid-cols-4">
                    <div class="relative overflow-hidden rounded-3xl">
                      ...
                      <div class="absolute inset-x-0 bottom-0 z-10 h-3/5 w-full bg-gradient-to-t from-black transition-all duration-500 ease-in-out group-hover:h-full" />
                    ...
                    <div class="relative">
                      ...
                      <div class="space-y-2">
                        ...
                        >
                          <BaseCard
                            rounded="lg"
                            class="shadow-sm shadow-muted-200 dark:shadow-muted-800 p-2 flex items-center gap-3"
                          >
                            <div class="relative">
                              <img
